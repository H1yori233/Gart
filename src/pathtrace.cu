...
static DevTexturePool dev_texture_pool;
...
void pathtraceInit(Scene* scene)
{
    ...
    uploadTexturePool(dev_texture_pool, scene->texture_pool);
...
void pathtraceFree()
{
    ...
    cudaFree(dev_texture_pool.image1s);
    cudaFree(dev_texture_pool.image3s);
